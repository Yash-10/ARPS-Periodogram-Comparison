...
dyn.load("/home/gcaceres/Documents/research/data/code/scratch_tests/BLS/bls_f95/eeblsf95.so")
blsf95 <- function(data.vals,     ## vector with signal
